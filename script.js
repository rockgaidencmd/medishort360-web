...
const LINKS_PERMITIDOS = [
    ...
    'https://ppls.me/JfqBhPiaw5CrPw1ZuP2qw',  // App individual $3 (ASPA / UCI)
    'https://ppls.me/Cm7e14nA79IaLuFxWqqaSQ'  // MS360 PRO $3.99
];
...
// ===== TEMPORIZADOR OFERTA MS360 PRO =====
(function initCountdown() {
    const el = document.getElementById('pro-countdown');
    const timeEl = document.getElementById('pro-countdown-time');
    if (!el || !timeEl) return;
    ...
    function actualizar() {
        ...
        if (restante <= 0) {
            // La oferta terminó: ocultar el contador
            timeEl.textContent = 'Oferta finalizada';
        ...
        timeEl.textContent = `${dias}d ${horas}h ${minutos}m`;
    }

    actualizar();
    const intervalo = setInterval(actualizar, 60000); // se actualiza cada minuto
})();
